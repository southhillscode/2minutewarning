...
class Data {
    class func getData() -> [ScheduleModel] {
        ...
        data.append(ScheduleModel(scheduleName: "Regular", period: "1", time: "7:45-8:37"))
        data.append(ScheduleModel(scheduleName: "Regular", period: "2", time: "8:42-9:34"))
        data.append(ScheduleModel(scheduleName: "Regular", period: "3", time: "9:39-10:31"))
        data.append(ScheduleModel(scheduleName: "Regular", period: "4", time: "10:46-11:38"))
        data.append(ScheduleModel(scheduleName: "Regular", period: "5", time: "11:43-12:35"))
