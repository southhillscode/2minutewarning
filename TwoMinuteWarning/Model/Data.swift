...
class Data {
    class func getData() -> [ScheduleModel] {
        ...
        data.append(ScheduleModel(scheduleName: "Regular", period: "0", time: "6:49-7:40"))
        data.append(ScheduleModel(scheduleName: "Late Start", period: "1", time: "7:45-8:37"))
        data.append(ScheduleModel(scheduleName: "Ext. Lunch", period: "2", time: "8:42-9:34"))
        data.append(ScheduleModel(scheduleName: "Ext. Break", period: "3", time: "9:39-10:31"))
        data.append(ScheduleModel(scheduleName: "Rally", period: "4", time: "10:46-11:38"))
        data.append(ScheduleModel(scheduleName: "Minimum", period: "5", time: "11:43-12:35"))
        data.append(ScheduleModel(scheduleName: "Final Exam", period: "6", time: "1:15-2:07"))
